...
@WebServlet(urlPatterns = "/CreatePupil")
public class CreatePupil extends HttpServlet {
   ...
   private Student getRequestBody(HttpServletRequest request) throws IOException {
      ...
      while ((line = reader.readLine()) != null)
         bodyJ.append(line);
      Gson gson = new Gson();
      st = gson.fromJson(bodyJ.toString(), new TypeToken<Student>() {
      }.getType());
      return st;
   }

   private int createPupil(Student req) {
